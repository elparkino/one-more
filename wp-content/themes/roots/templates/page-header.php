<div class="page-header">
	...
	<div class="row">	
		<div class="staar-logo span8">
				...
				<a href="<?php get_bloginfo('wpurl');?>/staar/"><img src="<?php get_bloginfo('wpurl');?>/staar/assets/img/STAAR-Test-Maker.png" alt="Star Test Maker" /></a>

				<div class="number-box">
						<img id="phone-sprite" src="<?php get_bloginfo('wpurl');?>/staar/assets/img/phone.jpg" alt="Phone No" /><span class="contact-numbers" id="phone"><a href="tel:800-930-8378">800-930-8378</a></span>
						<img id="fax-sprite" src="<?php get_bloginfo('wpurl');?>/staar/assets/img/fax.png"  alt="Fax No"/><span class="contact-numbers" id="fax">352-336-3782 </span>
				</div>
		</div>
